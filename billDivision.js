...
// Anna declines to eat item  which costs . If Brian calculates the bill correctly, Anna will pay . 
...
// the number of items ordered and the -based index of the item that Anna did not eat.
...
// otherwise, print the difference (i.e., ) that Brian must refund to Anna. This will always be an integer.
...
// 5
// Explanation 0
// Anna didn't eat item , but she shared the rest of the items with Brian. 
// The total cost of the shared items is  and, split in half, the cost per person is . 
...
// Anna didn't eat item , but she shared the rest of the items with Brian. 
// The total cost of the shared items is  and, split in half, the cost per person is . 
// Because , we print Bon Appetit on a new line.
